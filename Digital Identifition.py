...
imgfiles = 'D:\\beautyfish\\digital identifition\\Train\\*\\*.jpg'
...
imgfiles2 = 'D:/beautyfish/digital identifition/Test/*/*.jpg'
...
checkpointer = ModelCheckpoint(filepath='D:/beautyfish/digital identifition/checkpoint/weights01.hdf5', verbose=1, save_best_only=True)
...
model.save('D:/beautyfish/digital identifition/checkpoint/model01.h5')
